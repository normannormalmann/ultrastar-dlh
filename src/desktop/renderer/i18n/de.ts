...
export const de = {
  ...
  settings: {
    ...
    pathPlaceholder: "z.B. D:\\Karaoke\\songs",
    browse: "Durchsuchen…",
    cookieBrowser: "Browser für YouTube-Cookies",
    cookieBrowserHint:
      "yt-dlp nutzt die Cookies dieses Browsers, um YouTube-Bot-Schutz zu umgehen. Du solltest dort in YouTube eingeloggt sein.",
    downloads: "Downloads",
    folderLayoutLabel: "Ordnerstruktur neuer Downloads",
    layoutFlat: "Artist - Titel (flach)",
    layoutArtist: "Artist / Artist - Titel",
    layoutLetter: "A / Artist - Titel (Anfangsbuchstabe)",
    example: (pfad: string) => `Beispiel: ${pfad}`,
    parallelDownloads: "Parallele Downloads",
    videoQuality: "Video-Qualität",
    quality720: "max. 720p",
    quality1080: "max. 1080p",
    qualityBest: "Beste verfügbare",
    genreSource: "Genre-Quelle",
    genreSourceHint:
      "Quelle für das Nachtragen fehlender Genres (Bibliothek → „Genres nachtragen“). Deezer braucht keinen Key.",
    providerDeezer: "Deezer (empfohlen)",
    providerLastfm: "Last.fm (API-Key nötig)",
    providerMusicbrainz: "MusicBrainz (langsam, 1/s)",
    ...
    checking: "Prüfe…",
    sourceSystem: "System",
    sourceManaged: "App-verwaltet",
    sourceMissing: "fehlt",
    clearCoverCache: "Cover-Cache leeren",
    coversDeleted: (n: number) => `${n} Cover-Dateien gelöscht`,
    installing: "Installiere…",
    installMissingTools: "Fehlende Tools automatisch installieren",
    updating: "Aktualisiere…",
    updateNow: "Jetzt aktualisieren",
    manualBefore: "Manuelle Alternative: ",
    manualAfter: " installieren und in den PATH aufnehmen, dann App neu starten.",
    aiEnv: "KI-Umgebung (Song-Erstellung)",
    statusLabel: "Status:",
    lastError: (detail: string) => `Letzter Fehler: ${detail}`,
    envReady: (variante: string, python: string) =>
      `bereit (${variante}, Python ${python})`,
    envOutdated: "veraltet - Aktualisierung empfohlen",
    envBroken: (schritt: string) => `defekt (Schritt ${schritt})`,
    envMissing: "nicht eingerichtet",
    settingUp: "Richte ein…",
    retry: "Erneut versuchen",
    setupAiEnv: "KI-Umgebung einrichten (~8 GB)",
    ...
    downloadVersion: (v: string) => `Version ${v} herunterladen`,
    restartAndInstall: "Neu starten und installieren",
    updateDisabled: "Updates gibt es nur in der installierten App.",
    ...
    updateDownloading: (v: string) => `Lade Version ${v}…`,
    updateReady: (v: string) => `Version ${v} ist bereit.`,
    updateNotChecked: "Noch nicht geprüft.",
    language: "Sprache",
  },
};
